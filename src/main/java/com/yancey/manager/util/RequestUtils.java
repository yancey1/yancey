...
public class RequestUtils {
   ...
   * <code>HashTable</code> object with key-value pairs. The query string should
   * be in the form of a string packaged by the GET or POST method, that is, it
   * should have key-value pairs in the form <i>key=value</i>, with each pair
