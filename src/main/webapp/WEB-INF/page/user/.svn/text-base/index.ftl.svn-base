...
.cs-north-bg {
	width: 100%;
	height: 100%;
	background: url(/resources/js/easyui/themes/bootstrap/images/head.jpg) repeat-x;
}
.cs-north-logo {
	height: 30px;
...
<body class="easyui-layout">
	<div region="north" border="true" class="cs-north">
		<div class="cs-north-bg">
			<div class="" style="padding:0px;margin:0px;"><img src="/resources/js/easyui/themes/bootstrap/images/logo.png" style="height:40px;"/></div>
			<div class="cs-north-logo"></div>
			<div class="cs-north-info" style="font-size:14px;color:#ffffff;">
						<img src="/resources/js/easyui/themes/bootstrap/images/logoName.png" style="float:left;margin-right:620px;height:22px;"/>
				...
				<div title="${menu.resourceName}">
					<#list user.menuForms as result>
						<#if menu.resourceId == result.parent>
							<a href="javascript:void(0);" src="${result.resourceUrl}" class="cs-navi-tab">${result.resourceName}</a>
						</#if>
					</#list>
				</div>
			</#if>
