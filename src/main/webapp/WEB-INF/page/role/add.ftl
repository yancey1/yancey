	...
	<form id="ff" method="post" >
	    <table style=" border-spacing:10px; ">
	        <tr>
	            ...
	            <td><input class="easyui-validatebox" type="text" name="roleName" data-options="required:true,validType:'length[2,25]'"></td>
	        </tr>
	        <tr>
	            <td><label for="roles">角色代码:</label></td>
	            <td><input class="easyui-validatebox" type="text" name="roles" data-options="required:true,validType:'length[2,25]'"></td>
	        </tr>
	        <tr>
	            <td><label for="description">角色描述:</label></td>
	            <td><input class="easyui-validatebox" type="text" name="description" data-options="validType:'length[1,25]'"></td>
	        </tr>
	    </table>
	</form>
	</div>
